...
print()
print(f"{'Sequence':<30} {'Shots/vol':>10} {'Volumes':>10} {'Total shots':>12} {'Time':>12}")
print("-" * 76)
print(f"{'Multishot single-SE EPI':<30} {Ny:>10} {n_volumes_single:>10} "
      f"{Ny*n_volumes_single:>12} {fmt_time(t_multishot):>12}")
print(f"{'Singleshot single-SE EPI':<30} {1:>10} {n_volumes_single:>10} "
