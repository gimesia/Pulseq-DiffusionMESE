...
adcSSE_blipup = load_nii(
    f"volumes/brainweb-{subject}-ADC_NLLS_adc_sse_blipup_volume.nii.gz"
)
adcSSE_blipdown = load_nii(
    f"volumes/brainweb-{subject}-ADC_NLLS_adc_sse_blipdown_volume.nii.gz"
)
...
if REGISTER:
    ...
    adcSSE_blipup_reg = _reg(
        f"volumes/brainweb-{subject}-ADC_NLLS_adc_sse_blipup_volume.nii.gz"
    )
    adcSSE_blipdown_reg = _reg(
        f"volumes/brainweb-{subject}-ADC_NLLS_adc_sse_blipdown_volume.nii.gz"
    )
