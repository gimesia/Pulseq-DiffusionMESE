...
try:
    np.save(
        f"simulated/brainmaps/{phantoms[PHANTOM_IDX]}-T2_SSE_{'blipdown' if BLIP_DOWN else 'blipup'}.npy", ims2[0]
    )
    print("T2 map saved successfully.")
except Exception as e:
    print(f"Error occurred while saving T2 map: {e}")
# %%
